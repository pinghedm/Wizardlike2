...
def load_characters_config(asset_loader: 'AssetLoader'):
    try:
        with open('data/characters.yaml', 'r') as f:
...
def load_tiles_config(asset_loader: 'AssetLoader'):
    try:
        with open('data/tiles.yaml', 'r') as f:
...
class AssetLoader:
    ...
    def build_tileset(self) -> tcod.tileset.Tileset:
        ...
        self.tileset = tcod.tileset.load_tilesheet(
            base_path, 32, 8, tcod.tileset.CHARMAP_TCOD
        )
        ...
        for sprite_id, definition in self._mapping.items():
            ...
            try:
                ...
                final_tile[start_y : start_y + copy_h, start_x : start_x + copy_w] = \
                    resized[src_start_y : src_start_y + copy_h, src_start_x : src_start_x + copy_w]
