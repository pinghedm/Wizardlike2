...
WizardLike is a 2D roguelike game where survival depends on finding and combining ingredients to discover powerful spells. Inspired by the *Mystery Dungeon* series, it features a tile-based dungeon crawl, procedural level generation, and an experimental crafting system.
...
*Always run the data validator after modifying these files:*
```bash
