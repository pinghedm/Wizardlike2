...
def test_buying_through_the_shop_ui_spends_gold_for_stock():
    ...
    runner.simulate_key(pygame.K_RETURN)  # open shop
    runner.simulate_key(pygame.K_RIGHT)  # quantity -> 2
    runner.simulate_key(pygame.K_RIGHT)  # quantity -> 3
    runner.simulate_key(pygame.K_RETURN)  # buy 3
...
def test_quantity_adjusts_with_left_right_and_resets_when_the_cursor_moves():
    ...
    runner.simulate_key(pygame.K_LEFT)  # quantity -> 2
    assert ui_state.shop_quantity == 2

    runner.simulate_key(pygame.K_DOWN)  # move to the next offer
...
def test_buying_without_enough_gold_logs_a_warning_and_keeps_the_shop_open():
    ...
    runner.simulate_key(pygame.K_RETURN)  # open shop
    runner.simulate_key(pygame.K_RETURN)  # try to buy (can't afford)
