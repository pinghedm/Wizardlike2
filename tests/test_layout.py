...
def test_camera_centers_player_in_a_large_map():
    layout = _layout(80, 50)  # viewport 80x45
    # player minus half the viewport: (100-40, 100-22)
    assert layout.camera_offset(100, 100, 200, 200) == (60, 78)
...
def test_camera_clamps_to_bottom_right_corner():
    layout = _layout(80, 50)  # viewport 80x45; max offsets (120, 155)
    assert layout.camera_offset(199, 199, 200, 200) == (120, 155)
